			...
			<div className='padding container' id='profile'>
				...
				<div className='row mt-5'>
					<div className='col-12 col-md-3 offset-md-1'>
						...
						>
							<p>
								Hi! Thanks for visiting my personal page. I am Brenno, living in
								Canada since 2017. I am passionate about technology since I was
								a kid and I always wondered how the computer was able to perform
								so many amazing things. That curiosity leaded me to study more
								about computers and to who I am today.
							</p>
						</ScrollAnimation>
					</div>
					...
					<div className='col-12 col-md-3 mt-5 mt-md-0'>
						...
						<div className='profile-details'>
							...
							>
								...
								<br />
								<Label>Brenno Cesar Ferreira Lima</Label>
								<br />
								<Label>
									<b>Location:</b>
								</Label>
